...
const MinimalistSection = () => {
  const { title, subtitle, button, image } = content.minimalist;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-gray-50">
      <div className="flex flex-col items-center text-center">
        ...
        <div ref={imageRef} className="relative w-full max-w-3xl overflow-hidden rounded-2xl">
          <div className="absolute inset-0 bg-gradient-to-b from-gray-50 via-transparent to-transparent h-12 z-10"></div>
          <img 
            src={image.url}
            alt={image.alt}
